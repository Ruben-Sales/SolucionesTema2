...
```{r}
# b)
# En comparación al CodeBook perfecto, falta una breve definición de cada variable. Tampoco se da ninguna indicación del uso del conjunto de datos. Además, no se indican los valores que puede tomar cada variable. El CodeBook carece de información estadística y de unidades de medida. Por último, tampoco se habla de los outliers.
